...
export default {
    ...
    mounted() {
        ...
        flow.registerHTML("start", (flow, options) => {
            ...
            return `<div style='height: 100%; width: 100%; background: #fff; border: 2px solid ${themeColor}; box-sizing: border-box; color: ${themeColor}; display: flex;align-items: center;justify-content: center;font-size: .9em;'>开始</div>`;
        }, {
            width: 180,
            height: 60,
            text: true
